...
if(isset($_POST["btn_update"]))
{
    if($_POST["password"]!='')
    {
        if($_POST['password']==$_POST['cpassword'])
        {
            ...
            extract($_POST);
            $q1="UPDATE `tbl_student` SET `regno`='$regno',`stud_id`='$stud_id', `sfname`='$sfname',`slname`='$slname',`classname`='$classname',`semail`='$semail',`sgender`='$sgender',`sdob`='$sdob',`scontact`='$scontact',`saddress`='$saddress',`password`='$pass' WHERE `id`='".$_GET['id']."'";
        }
        else
        {
                                ...
                                <div class="input-states">
                                   ...
                                   <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="regno" value="<?php echo $regno;?>" class="form-control" placeholder="Roll Number" id="event" required>
                                                </div>
                                            </div>
                                        </div>
                                   <div class="form-group">
