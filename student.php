                    ...
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form" style="font-family:Algerian;">
                                <center><img src="stu1.png" style="width:70%;"></center><br>
                                <form method="POST">
                                    <div class="form-group">
                                        <label>Email address</label>
                                        <input type="email" name="email" class="form-control" placeholder="Email" required="" style="font-family:Times New Roman">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <p align=center class="role-msg" style="font-family:Footlight MT Light; font-size:20px;"><a href="login.php">Back</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
